...
2. 樂活五線譜（Happy Lines）與樂活通道（LOHAS Channel）：股價位階與動態判讀工具。
   - 五線譜位階：
     - 超跌 / 偏低：相對便宜，適合研究布局。
     - 平衡：中性位階。
     - 偏高 / 過熱：需注意追價風險與回檔機率。
   - 樂活通道（20 日高低點平均線）：
     - 跌破下限 (LB)：代表短線超跌且趨勢改變，此時**不宜急著買進**，應等待股價重新站回 LB 之內才確認止跌。
     - 突破上限 (UB)：代表短線超漲且極度強勢，此時**不宜急著賣出**，應續抱直到股價跌破 UB 進入通道內才執行獲利。
   - 綜合判讀：五線譜決定「價值位階」，樂活通道決定「安全買點」與「波段賣點」。
